        ...
        {searchTableType === "Credit Details" ? (
          <Table className="mt-4">
            <TableHeader className="bg-neutral-100 text-stone-950 ">
              ...
              <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`}>Receiving⠀Origin</TableHead>
              <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`}>Item⠀Type</TableHead>
              <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`}>Grade⠀Name</TableHead>

              <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`}>Net⠀Weight</TableHead>
              <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`}>Vendor_Name</TableHead>

              <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`}>Qty/Bag⠀Count</TableHead>
              <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`}>Total⠀Weight(Kg)</TableHead>
