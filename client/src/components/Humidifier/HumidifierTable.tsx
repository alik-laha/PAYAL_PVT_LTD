...
const HumidTable = (props:any) => {
   ...
   // const [hidetodate, sethidetoDate] = useState<string>('');
    ...
    },[editHumidLotWiseData, props.props])
    ...
    return (
        <>
            ...
            <div className="mt-5 ">
                ...
                <Table className="mt-4">
                    ...
                    <TableBody>
                        ...
                        {EditData.length > 0 && props.props==='edit'? (EditData.map((item: HumidData, idx) => {
                            ...
                            <TableCell className="text-center">{item.noOfOperators}</TableCell>
                                ...
                                <TableCell colSpan={19}><p className="font-bold tracking-widest uppercase text-center text-red-500 py-4 text-lg">No Result Found</p></TableCell>
            ...
            <dialog id="rcneditapproveRejectDialog" className="rounded-lg p-6 shadow-xl bg-white border border-green-300 text-center">
