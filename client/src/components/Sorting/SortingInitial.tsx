                                          ...
                                          <TableRow key={idx}>
                                              ...
                                              <TableCell className="text-center">
                                                ...
                                                <DialogContent className='max-w-screen'>
                                                          <DialogHeader>
                                                              <DialogTitle><p className='text-lg text-gray-600 text-center my-3 tracking-wider drop-shadow-xl font-bold'>Sorting Line Entry</p></DialogTitle>
                                      ...
                                      return (
                                          <TableRow key={idx}>
                                              ...
                                              <TableCell className="text-center">
                                                ...
                                                <DialogContent className='max-w-screen'>
                                                          <DialogHeader>
                                                              <DialogTitle><p className='text-lg text-gray-600 text-center mt-3 tracking-wider drop-shadow-xl font-bold'>Sorting Line Entry</p></DialogTitle>
