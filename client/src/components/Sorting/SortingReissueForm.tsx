...
const RCNSortingReCreateForm = (props:Props) => {
    ...
    const handleSubmit2 = async (e: React.FormEvent) => {
        ...
        //const operator = operatorRef.current?.value
            ...
            try {
                const initialhumid = await axios.post('/api/sorting/createReissueSorting', { linehumid:formData,
                    LotNo:props.borma[0].LotNo
                 })
                            ...
                            rows.map(( row:SortingRowData,idx:number) => {
                                ...
                                return (
                                    <TableRow key={idx} className="boiling-row-height-scoop">
                                        ...
                                        <TableCell className="text-center"> <Input className="bg-green-100" type="number" value={row.rcv_jjh} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'rcv_jjh', e.target.value)} required /></TableCell>
                                        <TableCell className="text-center font-semibold ">{formatNumber(props.borma[0].rcv_sjh)} Kg</TableCell>
                                        <TableCell className="text-center"> <Input className="bg-green-100" type="number" value={row.rcv_sjh} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'rcv_sjh', e.target.value)} required /></TableCell>
                                        
                                        <TableCell className="text-center font-semibold ">{formatNumber(props.borma[0].rcv_sjh1)} Kg</TableCell>
                                        <TableCell className="text-center"> <Input className="bg-green-100" type="number" value={row.rcv_sjh1} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'rcv_sjh1', e.target.value)} required /></TableCell>


                                        <TableCell className="text-center font-semibold ">{formatNumber(props.borma[0].rcv_jh1)} Kg</TableCell>
                                        <TableCell className="text-center"> <Input className="bg-green-100" type="number" value={row.rcv_jh1} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'rcv_jh1', e.target.value)} required /></TableCell>
                                        <TableCell className="text-center font-semibold ">{formatNumber(props.borma[0].rcv_jk_k)} Kg</TableCell>
                                        <TableCell className="text-center"> <Input className="bg-green-100" type="number" value={row.rcv_jk_k} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'rcv_jk_k', e.target.value)} required /></TableCell>
                                        
                                        <TableCell className="text-center font-semibold ">{formatNumber(props.borma[0].rcv_sp1)} Kg</TableCell>
                                        <TableCell className="text-center"> <Input className="bg-green-100" type="number" value={row.rcv_sp1} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'rcv_sp1', e.target.value)} required /></TableCell>
                                        ...
                                        <TableCell className="text-center"> <Input className="bg-green-100" type="number" value={row.rcv_bigTaiho} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'rcv_bigTaiho', e.target.value)} required /></TableCell>
