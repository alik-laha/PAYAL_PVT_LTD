...
const DPDSEditForm = (props:Props) => {
    ...
    useEffect(() => { 
        ...
        const initialform =  {
            ...
            rcv_dpN:  props.borma[0].issue_add_4,
            rcv_dsN:  props.borma[0].issue_add_5,
            rcv_dp1N:  props.borma[0].issue_add_6,
            ...
            issue_V_ds: props.borma[0].issue_V_ds,
            issue_V_m_ds: props.borma[0].issue_V_m_ds,
            issue_V_dp: props.borma[0].issue_V_dp,
            issue_V_m_dp: props.borma[0].issue_V_m_dp,
            issue_V_lp: props.borma[0].issue_V_lp,
            issue_V_lp_2: props.borma[0].issue_V_lp_2,
            issue_V_k_dp: props.borma[0].issue_V_k_dp,
            issue_V_ss: props.borma[0].issue_V_ss,
            issue_V_yjh: props.borma[0].issue_V_yjh,
            issue_V_yk: props.borma[0].issue_V_yk,
            issue_V_sp_2: props.borma[0].issue_V_sp_2,
            issue_V_kp: props.borma[0].issue_V_kp,
            issue_V_dp_2: props.borma[0].issue_V_dp_2,
            issue_V_dp_3: props.borma[0].issue_V_dp_3,
            issue_V_dp_4: props.borma[0].issue_V_dp_4,
            issue_V_os: props.borma[0].issue_V_os,
            issue_V_os_1: props.borma[0].issue_V_os_1,
            issue_V_wp: props.borma[0].issue_V_wp,
            issue_V_rs: props.borma[0].issue_V_rs,
        ...
        <div className="px-5 py-2 overflow-auto">
            <form className='flex flex-col gap-1 pt-5' onSubmit={handleSubmit2}>
               ...
               <Input className="w-2/4 font-semibold text-center bg-yellow-100" placeholder="Date" value={props.scoop[0].LotNo} readOnly /> </div> */}
                ...
                <Label className="w-100 pt-2 text-center">Update General Information</Label>
