                            ...
                            rows.map(( row:DPDSRowData,idx:number) => {
                                ...
                                return (
                                    <TableRow key={idx} className="boiling-row-height-scoop">
                                        ...
                                        <TableCell className="text-center font-semibold text-green-500">{formatNumber(row.rcv_dp)} Kg</TableCell>
                                        <TableCell className="text-center font-semibold text-green-500">{formatNumber(row.rcv_ds)} Kg</TableCell>
                                        <TableCell className="text-center font-semibold text-green-500">{formatNumber(row.rcv_dp1)} Kg</TableCell>
