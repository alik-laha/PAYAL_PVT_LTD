        ...
        <div>
            ...
            <div className='dashboard-main-container'>
                ...
                <div className="flexbox-tile bg-blue-500 hover:bg-orange-400">
                        Packing <br /><p>{data.data[0].issue_m_ds && data.data[0].issue_m_dp && data.data[0].issue_k_dp 
                        ...
                        && data.data[0].issue_ss_1 && data.data[0].issue_os && data.data[0].issue_os1
                        ...
                        +parseFloat(data.data[0].issue_ss_1)+parseFloat(data.data[0].issue_os)+parseFloat(data.data[0].issue_os1)
                ...
                <p className='text-lg font-semibold text-center '>Mayur</p>
                <div>
                    <Dialog>
