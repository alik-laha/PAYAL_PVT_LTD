    ...
    return (
        <div>
            ...
            <div className='dashboard-main-container'>
                ...
                <p className='text-lg text-gray-600 text-center pt-1 tracking-wider drop-shadow-xl font-bold'>CURRENT F.Y. {FY} REPORT (BIG-TAIHO)</p>
                <div>
                    <Dialog>
                        ...
                        <DialogContent className='max-w-3xl'>
                            <DialogHeader>
                                <DialogTitle><p className='text-lg text-gray-600 text-center mt-3 tracking-wider drop-shadow-xl font-bold'>BigTaiho Entry Form</p></DialogTitle>
