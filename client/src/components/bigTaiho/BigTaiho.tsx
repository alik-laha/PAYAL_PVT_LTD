        ...
        <div>
            ...
            <div className='dashboard-main-container'>
                ...
                <div className="flexbox-tile bg-blue-500 hover:bg-blue-400">
                        <p>Issue Packing</p> <br /><p>{data.data[0].issue_ssp && data.data[0].issue_ssp_small && data.data[0].issue_swp_1 
                        ...
                        && data.data[0].issue_add_10  && data.data[0].issue_ext_grade_1 && data.data[0].issue_ext_grade_2 &&
                    ...
                    <p>Issue Sorting</p> <br /><p>{data.data[0].issue_sorting ? formatNumber(parseFloat(data.data[0].issue_sorting))  : 0}  Kg</p>
                    </div>
                    ...
                    <p>Issue Husk</p> <br /><p>{data.data[0].issue_husk  ?  formatNumber(parseFloat(data.data[0].issue_husk)): 0} Kg</p>
                    </div>
               ...
               <p className='md:text-lg md:mt-0 mt-2 text-gray-600 text-center pt-1 tracking-wider drop-shadow-xl font-bold text-md'>CURRENT F.Y. {FY} REPORT (BIG-TAIHO)</p>
                <div>
                    ...
                    <Dialog>
                        ...
                        <DialogContent className='max-w-4xl'>
                            <DialogHeader>
                                <DialogTitle><p className='text-lg text-gray-600 text-center mt-3 tracking-wider drop-shadow-xl font-bold'>Big-Taiho Entry Form</p></DialogTitle>
                     ...
                     {checkpending('BigTaiho') && (data?.EditData ?? 0) > 0 && <Drawer>
                                            ...
                                            <DrawerContent>
                                                ...
                                                <div className='mx-5'>   <BigTaihoTable props='edit' /></div>
                                                <DrawerFooter>
                  ...
                  <Button className="w-25 md:w-40 bg-gradient-to-r from-purple-600 to-blue-400 hover:from-slate-500 hover:to-slate-300 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-200 mb-2 mt-5 ml-4 responsive-button-adjust no-margin-left drop-shadow-md" onClick={handleTransferFetch}> {maintable==='block' ? 'History':'Main Entry '}<FaHistory size={16} className='ml-2'/></Button>
                     ...
                     { (data?.PendingData ?? 0) > 0 && <Dialog>
                        ...
                        <DialogContent className='max-w-4xl'>
                            <DialogHeader>
                                <DialogTitle><p className='text-lg text-gray-600 text-center mt-3 tracking-wider drop-shadow-xl font-bold'>Big-Taiho Backlog</p></DialogTitle>

                            </DialogHeader>

                            <PendingBacklog props={'bigtaiho'} />
                        </DialogContent>
                    </Dialog>}
                </div>
                <div style={{ display: maintable }}>
                    <BigTaihoTable props='non-edit'/>
                </div>
