...
const BigTaihoEditForm = (props:Props) => {
    //console.log(props)
    ...
    useEffect(() => { 
        ...
        const initialform =  {
            ...
            issue_ssp: props.borma[0].issue_ssp,
                ...
                issue_wsp: props.borma[0].issue_wsp,
                issue_bits: props.borma[0].issue_bits,
                issue_swp: props.borma[0].issue_swp,
                issue_bb: props.borma[0].issue_bb,
                issue_w_bb: props.borma[0].issue_w_bb,
                issue_bb_A: props.borma[0].issue_bb_A,
                issue_bb1: props.borma[0].issue_bb1,
                issue_bb1_A: props.borma[0].issue_bb1_A,
                issue_bb_2: props.borma[0].issue_bb_2,
                issue_ssp_1: props.borma[0].issue_ssp_1,
                issue_ssp_1_small: props.borma[0].issue_ssp_1_small,
    ...
    const handleSubmit2 = async (e: React.FormEvent) => {
        ...
        //const operator = operatorRef.current?.value
            ...
            try {
                const initialhumid = await axios.post('/api/bigTaiho/updateBigTaiho', { linehumid:formData,
                    LotNo:props.borma[0].LotNo
                 })
...
export default BigTaihoEditForm;
