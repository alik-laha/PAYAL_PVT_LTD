    ...
    return (
        <div>
            ...
            <div className='dashboard-main-container'>
                ...
                <Dialog>
                    <DialogTrigger>   <Button className="bg-lime-500 mb-2 mt-5 ml-4 responsive-button-adjust no-margin-left items-center justify-center drop-shadow-md">+ Add User</Button></DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
