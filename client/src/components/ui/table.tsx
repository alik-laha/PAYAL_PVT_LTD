...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-gradient-to-r from-gray-700 via-gray-600 to-gray-500 text-white sticky top-0  z-30 shadow-lg shadow-black/20",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "py-[2vh] px-4 text-left align-middle font-bold uppercase text-[11px] tracking-widest text-white/90 whitespace-nowrap",
      className
    )}
    {...props}
  />
