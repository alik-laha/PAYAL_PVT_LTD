                        ...
                        {props.props.length > 0 ? (
                            props.props.map((item: lotPropsdata, idx: number) => {
                                ...
                                if(item.LotNo.includes('V')|| item.LotNo.includes('R')){
                                    ...
                                    if(item.rcv_mayur  && ((item.rcv_mayur ? parseFloat(item.rcv_mayur) : 0) + 
                            ...
                            <TableCell colSpan={5} className="text-center py-3 text-md text-red-500 font-semibold">No Pending LW</TableCell>
