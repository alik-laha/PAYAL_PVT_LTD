            ...
            <div className='dashboard-main-container'>
                <div className="flexbox-header">
                    ...
                    <div className="flexbox-tile bg-orange-500 hover:bg-orange-400">
                        Issue Hamsa <br /><p>{data.data[0].issue_lw ? formatNumber(parseFloat(data.data[0].issue_hamsa)) : 0}  Kg</p>
                    </div>
                ...
                <p className='text-lg text-gray-600 text-center pt-1 tracking-wider drop-shadow-xl font-bold'>CURRENT F.Y. {FY} REPORT (LOWER GRADING)</p>
                <div>
                    <Dialog>
                        ...
                        <DialogContent className='max-w-3xl'>
                            <DialogHeader>
                                <DialogTitle><p className='text-1xl pb-1 text-center mt-2'>LW Entry Form</p></DialogTitle>
                    ...
                    {checkpending('LW') && <Button className="bg-orange-400 mb-2 ml-4 responsive-button-adjust drop-shadow-md" onClick={handleEditFetch} disabled={data.EditData===0 ? true:false}> Pending Edit ({data.EditData})</Button>}
