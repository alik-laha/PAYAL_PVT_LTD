...
const LWCreateForm = (props: Props) => {
    ...
    useEffect(() => {
        const initialform = props.borma.map((item: LWData) => ({
            ...
            LotNo: item.LotNo,
            origin: item.origin,
            rcv_transfer: item.rcv_transfer||'0',
            rcv_mayur: item.rcv_mayur||'0',
            rcv_hamsa: item.rcv_hamsa||'0',
            rcv_wholes: item.rcv_wholes||'0',
            rcv_mayurN: item.rcv_mayur||0,
            rcv_hamsaN: item.rcv_hamsa||0,
            ...
            issue_add_1: formatNumber(item.rcv_mayur)||0,
            issue_add_2: '0',
            issue_add_3: '0',
            issue_add_4: formatNumber(item.rcv_hamsa)||0,
            issue_add_5: '0',
            issue_add_6: '0',
            issue_add_7: 0,
            issue_add_8: 0,
