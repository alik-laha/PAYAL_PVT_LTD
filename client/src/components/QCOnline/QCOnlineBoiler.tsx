 ...
 const payload = {
    ...
    axios.post("/api/qconline/createQCOnlineBoiler", payload)
      .then(() => {
        ...
        // reset form
        boiler1Ref.current!.value = ""
        boiler2Ref.current!.value = ""
      ...
      <div className="pb-6 px-6">
        <form className="flex flex-col gap-2" onSubmit={handleSubmit}>
          ...
          <div className="flex">
            ...
            <Select value={cleaningStatus} onValueChange={(val) => setCleaningStatus(val)} required>
