...
const QCOnlineScooping = () => {
  const [errortext, setErrorText] = useState<string>("")
  const [isdisable, setIsDisable] = useState<boolean>(false)

  const [oilcontainStatus, setOilContainStatus] = useState<string>("")
  const [chalnacontainStatus, setChalnaContainStatus] = useState<string>("")
  const cashewHuskRef = useRef<HTMLInputElement>(null)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const payload = {
      oilcontainStatus,
      chalnacontainStatus,
      cashewHuskprcnt: cashewHuskRef.current?.value,
      date,
      time,
      cleaningStatus,
    ...
    axios.post("/api/qconline/createQCOnlineScooping", payload)
      .then(() => {
        ...
        // reset form
        setOilContainStatus("")
        setChalnaContainStatus("")
        cashewHuskRef.current!.value = ""
        setCleaningStatus("")
...
export default QCOnlineScooping
