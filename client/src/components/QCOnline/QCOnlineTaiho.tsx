...
const QCOnlineTaiho = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    axios.post("/api/qconline/createQCOnlineTaiho", payload)
      .then(() => {
    ...
    <>
      ...
      <dialog id="successDialog" className="dashboard-modal">
        ...
        <span className="flex">
          ...
          <p className="pl-3 mt-1 font-medium">QC Online Taiho Reported successfully!</p>
        </span>
      </dialog>
