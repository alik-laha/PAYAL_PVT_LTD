...
const EditTaiho = ({ data }: Props) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    axios.put(`/api/qconline/updateQCOnlineTaiho/${data.id}`, payload)
      .then(() => {
    ...
    <>
      ...
      <dialog id="successDialog" className="dashboard-modal">
        ...
        <span className="flex">
          ...
          <p className="pl-3 mt-1 font-medium">QC Online Taiho updated successfully!</p>
        </span>
      </dialog>
