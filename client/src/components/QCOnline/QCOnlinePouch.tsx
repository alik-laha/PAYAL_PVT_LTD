      ...
      <div className="pb-6 px-6">
        <form className="flex flex-col gap-2" onSubmit={handleSubmit}>
          <div className="flex mt-1">
            ...
            <Input className="w-2/4 text-center" value={date} type="date" readOnly required />
          </div>

          <div className="flex mt-1">
            <Label className="w-2/4 pt-1">Time</Label>
            <Input className="w-2/4 text-center" value={time} type="time" readOnly required />
          </div>
          ...
          <div className="flex">
            ...
            <Input value={grade} placeholder="Final Grade"
          ...
          <div className="flex">
            <Label className="w-2/4 pt-1">Nutcount</Label>
