    ...
    <div className="ml-5 mt-5 ">
      ...
      <Table className="mt-4">
        <TableHeader className="bg-neutral-100 text-stone-950 ">
          ...
          <TableHead className="text-center">Boiling⠀Time</TableHead>
        ...
        <TableBody>
          {
            ItemWiseData.length > 0 ? (ItemWiseData.map((item: any, idx: number) => (
              <TableRow key={item.id}>
                ...
                <TableCell className="text-center"> {item.cashewStatus === "OK" ? (
                                                                            <p className="flex flex-row justify-center">
                                                                                                       <SiTicktick color="green" size={18} />
                                                                                                     </p>
                                                                        ) : (
                                                                            item.cashewStatus === "NOT OK" ? (
                                                                                <p className="flex flex-row justify-center">
                                                                                                       <BiErrorCircle   color="red" size={23} />
                                                                                                     </p>
                                                                            ) : item.cashewStatus)}</TableCell>
