    ...
    return (
        <div>
            ...
            <div className='dashboard-main-container'>
               ...
               <p className='md:text-lg md:mt-0 mt-2 text-gray-600 text-center pt-1 tracking-wider italic drop-shadow-xl font-bold text-md '>GENERAL ITEM TRANSACTION </p>
                ...
                <DialogContent className='max-w-2xl'>
                    <DialogHeader>
                        <DialogTitle><p className='text-lg text-gray-600 text-center pt-2 tracking-wider drop-shadow-xl font-bold'>General Entry Pending List</p></DialogTitle>
