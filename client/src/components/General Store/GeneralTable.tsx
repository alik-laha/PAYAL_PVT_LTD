...
const GeneralStoreTable = () => {
    ...
    return (
        <>
            ...
            {checkpending('RCNPrimary') &&  ((EditSumData?.GeneralPrimary ?? 0) !== 0)  &&
            ...
            (
                ...
                <Drawer>
                    ...
                    <Button
                        ...
                        disabled={(EditSumData?.GeneralPrimary ?? 0) === 0}
                    ...
                    {(EditSumData?.GeneralPrimary ?? 0) > 0 && (
