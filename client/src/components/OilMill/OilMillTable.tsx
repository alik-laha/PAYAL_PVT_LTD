...
const OilMillTable = (props:any) => {
                ...
                <Table className="mt-4">
                    <TableHeader className="bg-neutral-100 text-stone-950 ">
                       ...
                       <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`} >Action</TableHead>
                        ...
                        <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`} >OilMill⠀Type</TableHead>
                     
                        <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`} >Oilmill⠀Item⠀Invoice⠀No</TableHead>
                        ...
                        <TableHead className={`text-center ${props.props==='edit' ? 'bg-gray-100 text-gray-700':''}`} >Oilmill⠀Item⠀Vendor⠀Name</TableHead>
 ...
 <TableCell className="text-center" > <button
                                ...
                                <TableCell colSpan={18}><p className="font-bold tracking-widest uppercase text-center text-red-500 py-4 text-lg">No Result Found</p></TableCell>
