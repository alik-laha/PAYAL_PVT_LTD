        ...
        <div>
            ...
            <div className='dashboard-main-container'>
                ...
                {/* <Button className="bg-orange-400 mb-2 mt-5 ml-4" type="submit">+ Add New Enrty</Button> */}
                 <p className='md:text-lg md:mt-0 mt-2 text-gray-600 text-center pt-1 tracking-wider drop-shadow-xl font-bold text-md'>CURRENT F.Y. {FY} REPORT (WHOLES GRADING)</p>
                <div>
                    ...
                    <Dialog>
                                            ...
                                            <DialogContent className='max-w-4xl'>
                                                <DialogHeader>
                                                    <DialogTitle><p className='text-lg text-gray-600 text-center mt-3 tracking-wider drop-shadow-xl font-bold'>Wholes Entry Form</p></DialogTitle>
                    ...
                    {checkpending('Wholes') && (data?.EditData ?? 0) > 0 && <Drawer>
                                             ...
                                             <DrawerContent>
                                                 ...
                                                 <div className='mx-5'>   <WholesTable props='edit' /></div>
                                                 <DrawerFooter>
                    ...
                    <Button className="w-25 md:w-40 bg-gradient-to-r from-purple-600 to-blue-400 hover:from-slate-500 hover:to-slate-300 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-200 mb-2 mt-5 ml-4 responsive-button-adjust no-margin-left drop-shadow-md" onClick={handleTransferFetch}> {maintable==='block' ? 'History':'Main Entry '}<FaHistory size={16} className='ml-2'/></Button>
                     ...
                     { (data?.PendingData ?? 0) > 0 && <Dialog>
                        ...
                        <DialogContent className='max-w-4xl'>
                            <DialogHeader>
                                <DialogTitle><p className='text-lg text-gray-600 text-center mt-3 tracking-wider drop-shadow-xl font-bold'>Wholes Backlog</p></DialogTitle>

                            </DialogHeader>

                            <PendingBacklog props={'wholes'} />
                        </DialogContent>
                    </Dialog>}
                </div>
                <div style={{ display: maintable }}>
                    <WholesTable props='non-edit'/>
                </div>
