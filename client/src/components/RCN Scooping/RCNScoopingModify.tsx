...
const RCNScoopingModify = (props: RcnPrimaryModifyProps) => {
        ...
        <div className="pl-10 pr-10">
            ...
            <dialog id="rcneditscsDialog" className="rounded-lg p-6 shadow-xl bg-white border border-green-300 text-center">
                ...
                <span className="flex"><img src={tick} height={2} width={35} alt='tick_image' />
                    <p id="modal-text" className="pl-3 mt-1 font-medium text-green-500">RCN Primary Entry Modify request has created Successfully</p></span>
...
export default RCNScoopingModify