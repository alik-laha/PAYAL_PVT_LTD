...
const PeelingInitial = (props: any) => {
    ...
    const handleLineEntry = async (lotNO:string) => {
        const resStatus = await axios.post('/api/boiling/pendingLotCount', { lotNo: lotNO,section:'Humidifier'})
        ...
        axios.get(`/api/peeling/getPeelingByLot/${lotNO}`).then(res=>{
           console.log(res)
                ...
                <Table className="mt-3">
                    ...
                    <TableBody>
                        {props.props.length > 0 ? (
                            ...
                            <TableCell colSpan={4} className="text-center py-3 text-md text-red-500 font-semibold">No Pending Peeling</TableCell>
