    ...
    return (
        <div>
            ...
            <div className='dashboard-main-container'>
                ...
                <p className='text-lg text-gray-600 text-center mt-3 tracking-wider drop-shadow-xl font-bold'>CURRENT F.Y. {FY} REPORT (VILLAGE)</p>
                <div>
                    <Dialog>
                    ...
                    {checkpending('Village') && <Button className="bg-orange-400 mb-2 ml-4 responsive-button-adjust drop-shadow-md" onClick={handleEditFetch} disabled={data.EditData===0 ? true:false}> Pending Edit ({data.EditData})</Button>}
