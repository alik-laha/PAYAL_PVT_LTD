...
const VillageCreateForm = (props: Props) => {
    ...
    useEffect(() => {
        ...
        const initialform = props.borma.map((item: VilageData) => ({
            ...
            LotNo: item.LotNo,
            origin: item.origin,
            rcv_peeling: item.rcv_peeling||'0',
            rcv_mayur: item.rcv_mayur||'0',
            rcv_dpds: item.rcv_dpds||'0',
            rcv_wholes: item.rcv_wholes||'0',
            rcv_lw: item.rcv_lw||'0',
            rcv_bigTaiho: item.rcv_bigTaiho||'0',
            rcv_sorting: item.rcv_sorting||'0',
            rcv_rejection: item.rcv_rejection ? item.rcv_rejection : '0',
            rcv_peelingN: item.rcv_peeling||0,
            rcv_rejectionN: item.rcv_rejection ? item.rcv_rejection : '0',
            rcv_mayurN: item.rcv_mayur||0,
            issue_packing: 0,
            issue_mayur: 0,
            issue_hamsa: 0,
            issue_bigTaiho: 0,
            issue_rejection: 0,
            issue_outside: 0,
            issue_add_1: formatNumber(item.rcv_peeling)||0,
            issue_add_2: '0',
            issue_add_3: '0',
            issue_add_4: formatNumber(item.rcv_mayur)||0,
            issue_add_5: '0',
            issue_add_6: '0',
            issue_add_7:formatNumber(item.rcv_rejection)||0,
            issue_add_8: '0',
            issue_add_9: '0',
            issue_add_10: 0,
