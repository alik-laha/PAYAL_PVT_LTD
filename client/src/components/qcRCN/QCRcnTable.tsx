  ...
  return (
    <div className="ml-5 mt-5 ">
      ...
      <div className="flex flexbox-search">
        ...
        <select
          className="flexbox-search-width flex h-8 w-1/5 ml-10 items-center justify-between rounded-md border border-input bg-background px-3 py-1 text-sm 
    ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1"
        ...
        <Input
          className="w-1/6 flexbox-search-width-calender"
          type="date"
          value={fromdate}
                ...
                <TableRow key={item.id}>
                  ...
                  {/* <TableCell className="text-center">
                                  <input
                                    type="checkbox"
                                    checked={
                                      item.reportStatus === 1 ? true : false
                                    }
                                  />
                                </TableCell> */}
                  <TableCell className="text-center font-semibold">
