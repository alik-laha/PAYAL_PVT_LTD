...
const RejectionEDitForm = (props: Props) => {
    //console.log(props)
    ...
    useEffect(() => {
        ...
        const initialform = {
            ...
            rcv_mayurN: props.borma[0].issue_add_8,
            rcv_peelingN: props.borma[0].issue_add_7,

            issue_packing: props.borma[0].issue_packing,
        issue_village: props.borma[0].issue_village,
        issue_uncut_unscoop: props.borma[0].issue_uncut_unscoop,
        issue_shell: props.borma[0].issue_shell,
        issue_catelfeed: props.borma[0].issue_catelfeed,
    ...
    const handleSubmit2 = async (e: React.FormEvent) => {
        ...
        if (resStatus1.data.scoopingLot[0].latest_section && resStatus1.data.scoopingLot[0].latest_section !=='Rejection') 
            {
        ...
        //const operator = operatorRef.current?.value
            ...
            try {
                const initialhumid = await axios.post('/api/rejection/updateRejection', { linehumid:formData,
                    LotNo:props.borma[0].LotNo
                 })
...
export default RejectionEDitForm;
