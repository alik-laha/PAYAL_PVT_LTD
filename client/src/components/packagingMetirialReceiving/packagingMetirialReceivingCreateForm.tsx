    ...
    return (
        <>
            <div className="mt-4">
                ...
                <div><Label className="text-xs text-gray-500 font-semibold">GatePass No.</Label>
                ...
                <div ><Label className="text-xs text-gray-500 font-semibold">Date</Label>
                <Input className="mt-1 bg-yellow-50 font-semibold text-center border-gray-300" placeholder="BL No." value={date}  readOnly /> </div> 
           
                <div ><Label className="text-xs text-gray-500 font-semibold">Vehicle No.</Label>
                <Input className="mt-1 bg-yellow-50 font-semibold text-center border-gray-300" placeholder="BL No." value={truck}  readOnly /> </div> 
                <div><Label className="text-xs text-gray-500 font-semibold">Invoice No</Label>
                <Input className="mt-1 text-center border-gray-400" placeholder="Invoice No" required  ref={invoiceref} /> </div>

                <div><Label className="text-xs text-gray-500 font-semibold">Invoice Date</Label>
                <Input className="mt-1 text-center border-gray-400" placeholder="Invoice Date" required ref={invoicedateRef} type="date" /> </div>
                <div><Label className="text-xs text-gray-500 font-semibold">Vendor Name</Label>
                <div >
                <Input className="mt-1  text-center border-gray-400" placeholder="Vendor" required value={VendorName} onChange={(e)=>{handleVendorChange(e)}} /> 
                ...
                <button className="bg-blue-400 font-bold text-grey-700 w-8 h-8 text-primary-foreground rounded-md text-center items-center justify-center"
                    ...
                    <Table className="mt-1 ">
                        <TableHeader className="bg-neutral-100 text-stone-950" >
                            ...
                            <TableHead className="text-center" >SKU⠀Name/Item⠀Name</TableHead>
