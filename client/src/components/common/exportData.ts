...
export const PermissionRol = {
    Director: ['Employee', 'Dashboard User', 'Asset', 'VendorSKU','Store Issue',
        ...
        'RCN Incoming QC', 
        'Grading', 'Boiling', 'Scooping','Borma','Humidifier','Peeling','Mayur','Sorting','DPDS','BigTaiho','Hamsa','Wholes','LW',
        'Cleaning',
        'Gatepass'],
    ...
    ProductionManager:['Grading','Boiling','Scooping','Borma','Humidifier','Peeling','Mayur','Wholes','LW',
        'DPDS','Hamsa','BigTaiho','Sorting','Receiving Village Entry'],
    DeputyProductionManager : ['Borma','Humidifier','Peeling','Mayur','Wholes','LW',
        'DPDS','Hamsa','BigTaiho','Sorting','Receiving Village Entry'], 
