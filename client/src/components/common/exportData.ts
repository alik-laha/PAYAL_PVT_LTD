...
export const pendingCheckRole = {
    ...
    OrderCreate: ['Director', 'FactoryManager', 'ProductionManager','GatePassManager'],
    OrderMapping: ['Director', 'FactoryManager', 'ProductionManager','GatePassManager'],
    ProdStockExcel: ['Director', 'FactoryManager', 'ProductionManager','GatePassManager'],
