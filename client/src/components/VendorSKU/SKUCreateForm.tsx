    ...
    return (
        ...
        <div className="pl-10 pr-10">
            ...
            <div className="flex"><Label className="w-2/4  pt-1">Section</Label>
                    ...
                    <select className="w-2/4 font-cursive text-center flex h-8 rounded-md border border-input bg-background 
                                            ...
                                            value={type} required>
                                                <option value="" disabled className="font-cursive relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent 
                                        ...
                                        TypeOnSection[section as keyof typeof TypeOnSection].map((item) => (
                                            <option key={item} className='font-cursive' value={item}>{item}</option>
                                        ))
                                    ) : null}
                                            </select>
                    {/* <Input   placeholder="Section"/>  */}
