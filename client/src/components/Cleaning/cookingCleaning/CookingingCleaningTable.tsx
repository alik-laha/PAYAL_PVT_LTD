...
const CookingCleanTable = () => {
    ...
    const successdialog = document.getElementById('imageDailogBoillingClean') as HTMLInputElement;
    const closeDialogButton = document.getElementById('closeDialogBoillingClean') as HTMLInputElement;
    ...
    ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1'
        ...
        py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50' value=''>Origin (All)</option>
            ...
            <dialog id="imageDailogBoillingClean" className="dashboard-modal">
                <button id="closeDialogBoillingClean" className="dashboard-modal-close-btn ">X </button>
                <span className="flex">{
