...
const AbhayMcTable = () => {
    ...
    const successdialog = document.getElementById('AbhayMcmyDialog') as HTMLInputElement;
    const closeDialogButton = document.getElementById('AbhayMccloseDialog') as HTMLInputElement;
    ...
    const handleSearch = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        e.preventDefault()
        axios.post('/api/cleaning/abhaycleanview', { fromdate, todate })
            .then((res) => {
    ...
    useEffect(() => {
        ...
        axios.post('/api/cleaning/abhaycleanview')
            .then((res) => {
                setCleanTable(res.data)
    ...
    return (
        <div className="ml-5 mt-5 ">
            ...
            <dialog id="AbhayMcmyDialog" className="dashboard-modal">
                <button id="AbhayMccloseDialog" className="dashboard-modal-close-btn ">X </button>
                <span className="flex">{
