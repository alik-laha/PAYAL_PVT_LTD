...
const RCNMayurReCreateForm = (props: Props) => {
    ...
    const handleSubmit2 = async (e: React.FormEvent) => {
        ...
        try {
            const initialhumid = await axios.post('/api/mayur/createReissueMayur', {
                linehumid: formData,
                LotNo: props.borma[0].LotNo
            })
        ...
        <>
            <div className="px-5 py-2 overflow-auto">
               ...
               <Input className="w-2/4 font-semibold text-center bg-yellow-100" placeholder="Date" value={props.scoop[0].LotNo} readOnly /> </div> */}
                                ...
                                rows.map((row: mayurRowData, idx: number) => {
                                    ...
                                    return (
                                        <TableRow key={idx} className="boiling-row-height-scoop">
                                            ...
                                            <TableCell className="text-center font-semibold ">{formatNumber(props.borma[0].rcv_wholespeel)} Kg </TableCell>
                                            ...
                                            <TableCell className="text-center font-semibold ">{formatNumber(props.borma[0].rcv_wholesunpeel)} Kg</TableCell>
                                ...
                                rows.map((row: mayurRowData, idx: number) => {
                                    ...
                                    return (
                                        <TableRow key={idx} className="boiling-row-height-scoop">
                                            ...
                                            <TableCell className="text-center"> <Input className='bg-yellow-200' type="number" value={row.issue_pw_w} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'issue_pw_w', e.target.value)} required /></TableCell>
                                            <TableCell className="text-center"> <Input className='bg-yellow-200' type="number" value={row.issue_w_lot} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'issue_w_lot', e.target.value)} required /></TableCell>
                                            <TableCell className="text-center"> <Input className='bg-yellow-200' type="number" value={row.issue_ww} placeholder="Pr." onChange={(e) => handleRowChange(idx, 'issue_ww', e.target.value)} required /></TableCell>
                    ...
                    <Label className="w-100 pt-5 text-center font-semibold">2. Machine Information</Label>
                    <Table className="mt-3">
                        <TableHeader className="bg-neutral-100 text-stone-950 ">
                            <TableHead className="text-center">Mc On 133</TableHead>
                            <TableHead className="text-center ">Mc Off 133</TableHead>
