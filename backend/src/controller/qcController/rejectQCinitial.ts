...
const rejectQCinitial = async (req: Request, res: Response) => {
    try {
       ...
       // const approvedBy = "RC Admin 1";
        ...
        return res.status(200).json({ message: "QC Approval of Rcn Entry is Rejected Successfully" });
...
export default rejectQCinitial;