...
const sumOfallHumid = async (req: Request, res: Response) => {
    try {
        ...
        const data = await Humidifier.findAll({
            attributes: [
        ...
        const EditData = await HumidifierEdit.count()
        if (data) {
