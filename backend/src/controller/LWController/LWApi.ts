...
export const findEditLWAll = async (req: Request, res: Response) => {
  try {
    const scoopingAllEdit = await LWEditModel.findAll({
      order: [
        ["LotNo", "DESC"],
        ["date", "DESC"],
      ],
...
export const sumOfallLW = async (req: Request, res: Response) => {
  try {
    ...
    if (
      today.getHours() < 5 ||
      (today.getHours() === 5 && today.getMinutes() <= 30)
    ) {
    ...
    const Sumdata = await LWModel.findAll({
      attributes: [
        [
          sequelize.fn("sum", sequelize.col("current_backlog")),
          "current_backlog",
        ],
      ],
      where: {
    ...
    const data = await LWModel.findAll({
      attributes: [
        ...
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_1")),
          "issue_ext_grade_1",
        ],
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_2")),
          "issue_ext_grade_2",
        ],
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_3")),
          "issue_ext_grade_3",
        ],
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_4")),
          "issue_ext_grade_4",
        ],
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_5")),
          "issue_ext_grade_5",
        ],
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_6")),
          "issue_ext_grade_6",
        ],
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_7")),
          "issue_ext_grade_7",
        ],
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_8")),
          "issue_ext_grade_8",
        ],
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_9")),
          "issue_ext_grade_9",
        ],
        [
          sequelize.fn("sum", sequelize.col("issue_ext_grade_10")),
          "issue_ext_grade_10",
        ],

        [
          sequelize.fn("sum", sequelize.col("issue_rejection")),
          "issue_rejection",
        ],
        [sequelize.fn("sum", sequelize.col("issue_village")), "issue_village"],
        [
          sequelize.fn("sum", sequelize.col("issue_bigTaiho")),
          "issue_bigTaiho",
        ],
    ...
    const PendingData = await LWModel.count({
      where: {
        [Op.or]: [{ editStatus: "Approved" }, { editStatus: "NA" }],
        latest: 1,
        current_backlog: {
...
export const CreateEntireLW = async (req: Request, res: Response) => {
  try {
    ...
    await sequelize.transaction(async (transaction: any) => {
      for (let data of linehumid) {
        if (
          ...
          Number(
            (
              parseFloat(data.issue_kw) +
              parseFloat(data.issue_kw_1) +
              parseFloat(data.issue_kw_2) +
              parseFloat(data.issue_kn) +
              parseFloat(data.issue_dw) +
              parseFloat(data.issue_dw_1) +
              parseFloat(data.issue_dw_2) +
              parseFloat(data.issue_ow) +
              parseFloat(data.issue_ow_1) +
              parseFloat(data.issue_ow_2) +
              parseFloat(data.issue_jw) +
              parseFloat(data.issue_pw) +
              parseFloat(data.issue_row) +
              parseFloat(data.issue_rej_1) +
              parseFloat(data.issue_lw3_180) +
              parseFloat(data.issue_lw3_210) +
              parseFloat(data.issue_lw3_240) +
              parseFloat(data.issue_lw3_280) +
              parseFloat(data.issue_lw3_360) +
              parseFloat(data.issue_lw2) +
              parseFloat(data.issue_lw4) +
              parseFloat(data.issue_lw5) +
              parseFloat(data.issue_lw6) +
              parseFloat(data.issue_lw7) +
              parseFloat(data.issue_rej_3) +
              parseFloat(data.issue_rej_4) +
              parseFloat(data.issue_jb2) +
              parseFloat(data.issue_sjb) +
              parseFloat(data.issue_k_240) +
              parseFloat(data.issue_k_280) +
              parseFloat(data.issue_k_360) +
              parseFloat(data.issue_pkw) +
              parseFloat(data.issue_bw) +
              parseFloat(data.issue_rw) +
              parseFloat(data.issue_rrw) +
              parseFloat(data.issue_fw) +
              parseFloat(data.issue_lw) +
              parseFloat(data.issue_village) +
              parseFloat(data.issue_hamsa) +
          ...
          res
            .status(500)
            .json({ message: "Backlog can't be Greater Than Input" });
        ...
        if (LWUpdate) {
          ...
          if (hamsa_backlog && hamsa_backlog.dataValues.current_backlog >= 0) {
            await sectionTransfer.create(
              {
                ...
                toSectionBeforeBacklog:
                  hamsa_backlog.dataValues.current_backlog,
                toSectionAfterBacklog:
                  parseFloat(hamsa_backlog.dataValues.current_backlog) +
                  parseFloat(data.issue_hamsa),
                createdBy: feeledBy,
              },
              { transaction },
              ...
              await hamsaModel.update(
                {
                  ...
                  current_backlog: sequelize.literal(
                    `current_backlog+ ${data.issue_hamsa}`,
                  ),
                },
                {
                  where: {
            ...
            res
              .status(500)
              .json({ message: "Error In Creating Hamsa Transaction History" });
          ...
          if (bigT_backlog && bigT_backlog.dataValues.current_backlog >= 0) {
            await sectionTransfer.create(
              {
                ...
                toSectionAfterBacklog:
                  parseFloat(bigT_backlog.dataValues.current_backlog) +
                  parseFloat(data.issue_bigTaiho),
                createdBy: feeledBy,
              },
              { transaction },
              ...
              await bigTaihoModel.update(
                {
                  ...
                  current_backlog: sequelize.literal(
                    `current_backlog+ ${data.issue_bigTaiho}`,
                  ),
                },
                {
                  where: {
            ...
            res
              .status(500)
              .json({
                message: "Error In Creating BigTaiho Transaction History",
              });
            throw new Error("Transaction Aborted");
          }
          ...
          if (
            rejection_backlog &&
            rejection_backlog.dataValues.current_backlog >= 0
          ) {
            await sectionTransfer.create(
              {
                LotNo: LotNO,
                ...
                toSection: "Rejection",
                toSectionBeforeBacklog:
                  rejection_backlog.dataValues.current_backlog,
                toSectionAfterBacklog:
                  parseFloat(rejection_backlog.dataValues.current_backlog) +
                  parseFloat(data.issue_rejection),
                createdBy: feeledBy,
              },
              { transaction },
              ...
              await rejectionModel.update(
                {
                  ...
                  current_backlog: sequelize.literal(
                    `current_backlog+ ${data.issue_rejection}`,
                  ),
                },
                {
                  where: {
            ...
            res
              .status(500)
              .json({
                message: "Error In Creating Rejection Transaction History",
              });
            throw new Error("Transaction Aborted");
          }
          ...
          if (vil_backlog && vil_backlog.dataValues.current_backlog >= 0) {
            await sectionTransfer.create(
              {
                ...
                toSectionAfterBacklog:
                  parseFloat(vil_backlog.dataValues.current_backlog) +
                  parseFloat(data.issue_village),
                createdBy: feeledBy,
              },
              { transaction },
              ...
              await villageProduction.update(
                {
                  ...
                  current_backlog: sequelize.literal(
                    `current_backlog+ ${data.issue_village}`,
                  ),
                },
                {
                  where: {
            ...
            res
              .status(500)
              .json({
                message: "Error In Creating Village Transaction History",
              });
            throw new Error("Transaction Aborted");
          }
          ...
          if (lotupdate) {
            res
              .status(200)
              .json({ message: "Lower Grade Entry Made Successfully" });
          } else {
    ...
    if (!res.headersSent) {
      ...
      return res
        .status(500)
        .json({ message: "Error while creating LW Entry", error });
    }
  }
};
...
export const CreateReissueLW = async (req: Request, res: Response) => {
  try {
    ...
    await sequelize.transaction(async (transaction: any) => {
      for (let data of linehumid) {
        if (
          Number(parseFloat(data.rcv_openingN).toFixed(2)) <
          Number(
            (
              parseFloat(data.issue_kw) +
              parseFloat(data.issue_kw_1) +
          ...
          if (reissuecreate) {
            ...
            if (bigT_backlog && bigT_backlog.dataValues.current_backlog >= 0) {
              await sectionTransfer.create(
                {
                  ...
                  toSection: "BigTaiho",
                  toSectionBeforeBacklog:
                    bigT_backlog.dataValues.current_backlog,
                  toSectionAfterBacklog:
                    parseFloat(bigT_backlog.dataValues.current_backlog) +
                    parseFloat(data.issue_bigTaiho),
                  createdBy: feeledBy,
              ...
              res
                ...
                .json({
                  message:
                    "Error In Creating Reissue BigTaiho Transaction History",
                });
              throw new Error("Transaction Aborted");
            }
            ...
            if (
              ...
              res
                ...
                .json({
                  message:
                    "Error In Creating Reissue Rejection Transaction History",
                });
              throw new Error("Transaction Aborted");
            }
            ...
            if (vil_backlog && vil_backlog.dataValues.current_backlog >= 0) {
              await sectionTransfer.create(
                {
                  ...
                  toSection: "Village",
                  toSectionBeforeBacklog:
                    vil_backlog.dataValues.current_backlog,
                  toSectionAfterBacklog:
                    parseFloat(vil_backlog.dataValues.current_backlog) +
                    parseFloat(data.issue_village),
                  createdBy: feeledBy,
              ...
              res
                ...
                .json({
                  message:
                    "Error In Creating Village Reissue Transaction History",
                });
              throw new Error("Transaction Aborted");
            }
            ...
            if (
              hamsa_backlog &&
              hamsa_backlog.dataValues.current_backlog >= 0
            ) {
              await sectionTransfer.create(
                {
                  LotNo: LotNO,
              ...
              res
                ...
                .json({
                  message:
                    "Error In Creating Hamsa Re-Issue Transaction History",
                });
              throw new Error("Transaction Aborted");
            }
            ...
            if (lotoriginupdate) {
              res
                .status(200)
                .json({ message: "LW Reissue Entry Made Successfully" });
            } else {
              console.log("No Need For Update");
            }
          } else {
            return res
              .status(500)
              .json({ message: "Error while creating LW Re Issue Entry" });
          }
        }
      }
    });
...
export const updateEntireLW = async (req: Request, res: Response) => {
  try {
    ...
    await sequelize.transaction(async (transaction: any) => {
      for (let data of linehumid) {
        ...
        if (lotupdate) {
          ...
          return res
            .status(201)
            .json({ message: "Edit Request of LW Entry Raised successfully" });
        } else {
          console.log("No Need For Update");
        }
      }
    ...
    if (!res.headersSent) {
      ...
      return res
        .status(500)
        .json({ message: "Error while Editing LW Entry", error });
    }
  }
};
...
export const approveLW = async (req: Request, res: Response) => {
  try {
    ...
    if (!id || !approvedBy) {
      return res
        .status(400)
        .json({ message: "Please provide the id or approved by" });
    }
      ...
      if (
        ...
        await sequelize.transaction(async (transaction: any) => {
          ...
          if (BigTEdit) {
            ...
            if (
              parseFloat(transferVildata.amount) !==
              parseFloat(data.issue_village)
            ) {
              console.log("Needs Update In Village");
              const difference_vil =
                parseFloat(data.issue_village) -
                parseFloat(transferVildata.amount);
              ...
              if (backlog && backlog.dataValues.current_backlog >= 0) {
                await villageProduction.update(
                  {
                    ...
                    current_backlog: sequelize.literal(
                      `current_backlog+ ${difference_vil}`,
                    ),
                  },
                  {
                    where: {
                ...
                await sectionTransfer.update(
                  {
                    ...
                    amount: data.issue_village,
                    toSectionBeforeBacklog:
                      transferVildata.toSectionBeforeBacklog,
                    toSectionAfterBacklog:
                      parseFloat(transferVildata.toSectionBeforeBacklog) +
                      parseFloat(data.issue_village),
                  },
                  {
                    where: {
                ...
                res
                  .status(500)
                  .json({ message: "Associated Village Entry Not Found" });
                throw new Error("Transaction Aborted due to Improper Value");
              }
            }

            if (
              parseFloat(transferRejectiondata.amount) !==
              parseFloat(data.issue_rejection)
            ) {
              console.log("Needs Update In Rejection");
              const difference_rejection =
                parseFloat(data.issue_rejection) -
                parseFloat(transferRejectiondata.amount);
              ...
              if (backlog && backlog.dataValues.current_backlog >= 0) {
                await rejectionModel.update(
                  {
                    rcv_lw: sequelize.literal(
                      `rcv_lw+ ${difference_rejection}`,
                    ),
                    current_backlog: sequelize.literal(
                      `current_backlog+ ${difference_rejection}`,
                    ),
                  },
                  {
                    where: {
                ...
                await sectionTransfer.update(
                  {
                    ...
                    amount: data.issue_rejection,
                    toSectionBeforeBacklog:
                      transferRejectiondata.toSectionBeforeBacklog,
                    toSectionAfterBacklog:
                      parseFloat(transferRejectiondata.toSectionBeforeBacklog) +
                      parseFloat(data.issue_rejection),
                  },
                  {
                    where: {
                ...
                res
                  .status(500)
                  .json({ message: "Associated Rejection Entry Not Found" });
                throw new Error("Transaction Aborted due to Improper Value");
              }
            }

            if (
              parseFloat(transferBigTdata.amount) !==
              parseFloat(data.issue_bigTaiho)
            ) {
              console.log("Needs Update In BigTaiho");
              const difference_bigT =
                parseFloat(data.issue_bigTaiho) -
                parseFloat(transferBigTdata.amount);
              ...
              if (backlog && backlog.dataValues.current_backlog >= 0) {
                await bigTaihoModel.update(
                  {
                    ...
                    current_backlog: sequelize.literal(
                      `current_backlog+ ${difference_bigT}`,
                    ),
                  },
                  {
                    where: {
                ...
                await sectionTransfer.update(
                  {
                    ...
                    amount: data.issue_bigTaiho,
                    toSectionBeforeBacklog:
                      transferBigTdata.toSectionBeforeBacklog,
                    toSectionAfterBacklog:
                      parseFloat(transferBigTdata.toSectionBeforeBacklog) +
                      parseFloat(data.issue_bigTaiho),
                  },
                  {
                    where: {
                ...
                res
                  .status(500)
                  .json({ message: "Associated BigTaiho Entry Not Found" });
                throw new Error("Transaction Aborted due to Improper Value");
              }
            }

            if (
              parseFloat(transferHamsadata.amount) !==
              parseFloat(data.issue_hamsa)
            ) {
              console.log("Needs Update In Hamsa");
              const difference_hamsa =
                parseFloat(data.issue_hamsa) -
                parseFloat(transferHamsadata.amount);
              ...
              if (backlog && backlog.dataValues.current_backlog >= 0) {
                await hamsaModel.update(
                  {
                    ...
                    current_backlog: sequelize.literal(
                      `current_backlog+ ${difference_hamsa}`,
                    ),
                  },
                  {
                    where: {
                ...
                await sectionTransfer.update(
                  {
                    ...
                    amount: data.issue_hamsa,
                    toSectionBeforeBacklog:
                      transferHamsadata.toSectionBeforeBacklog,
                    toSectionAfterBacklog:
                      parseFloat(transferHamsadata.toSectionBeforeBacklog) +
                      parseFloat(data.issue_hamsa),
                  },
                  {
                    where: {
                ...
                res
                  .status(500)
                  .json({ message: "Associated Hamsa Entry Not Found" });
                throw new Error("Transaction Aborted due to Improper Value");
              }
            }
            await lotoriginmodel.update(
            ...
            return res
              .status(200)
              .json({
                message: "Edit Request of LW Entry is Approved Successfully",
              });
          }
        });
      } else {
        return res
          .status(400)
          .json({ message: "LW Transfer Entry is not found" });
      }
    }
  } catch (err) {
    console.log(err);
...
export const EditRejectLW = async (req: Request, res: Response) => {
  try {
    ...
    if (!id || !rejectedBy) {
      return res
        .status(400)
        .json({ message: "Please provide the id or rejected By" });
    }
...
export const CreateMixLW = async (req: Request, res: Response) => {
  try {
    ...
    await sequelize.transaction(async (transaction: any) => {
      ...
      if (sourcedata) {
        const mayurdiff =
          parseFloat(sourcedata.dataValues.issue_add_7) -
          parseFloat(source_rcv_mayur);
        const totbeforebormamayur =
          parseFloat(sourcedata.dataValues.rcv_mayur) - mayurdiff;
        const totafterbormamayur = parseFloat(source_rcv_mayur);

        const hamsadiff =
          parseFloat(sourcedata.dataValues.issue_add_8) -
          parseFloat(source_rcv_hamsa);
        const totbeforebormahamsa =
          parseFloat(sourcedata.dataValues.rcv_hamsa) - hamsadiff;
        ...
        sourceupdate = await LWModel.update(
          {
            ...
            issue_add_3:
              ((totbeforebormamayur - totafterbormamayur) /
                totbeforebormamayur) *
              100,
            ...
            issue_add_6:
              ((totbeforebormahamsa - totafterbormahamsa) /
                totbeforebormahamsa) *
              100,
      ...
      if (destdata) {
        ...
        if (Number(destrcv_status) === 0) {
          destupdate = await LWModel.update(
            {
              ...
              mixingLot: destdata.dataValues.mixingLot
                ? sequelize.literal(
                    `CONCAT(mixingLot,'${sourcelot}(${sourceorigin})')`,
                  )
                : `${sourcelot}(${sourceorigin})`,
            },
            {
              where: {
                id: destid,
          ...
          const mayurdiffD =
            parseFloat(dest_rcv_mayur) -
            parseFloat(destdata.dataValues.issue_add_7);
          const totbeforebormaDmayur =
            parseFloat(destdata.dataValues.rcv_mayur) + mayurdiffD;
          const totafterbormaDmayur = parseFloat(dest_rcv_mayur);

          const hamsadiffD =
            parseFloat(dest_rcv_hamsa) -
            parseFloat(destdata.dataValues.issue_add_8);
          const totbeforebormaDhamsa =
            parseFloat(destdata.dataValues.rcv_hamsa) + hamsadiffD;
          ...
          destupdate = await LWModel.update(
            {
              ...
              issue_add_3:
                ((totbeforebormaDmayur - totafterbormaDmayur) /
                  totbeforebormaDmayur) *
                100,
              issue_add_7: dest_rcv_mayur,

              rcv_hamsa: sequelize.literal(`rcv_hamsa+ ${hamsadiffD}`),
              issue_add_6:
                ((totbeforebormaDhamsa - totafterbormaDhamsa) /
                  totbeforebormaDhamsa) *
                100,
        ...
        if (sourceupdate && destupdate) {
          ...
          if (mixcreate) {
            return res
              .status(200)
              .json({ message: "Mixing Performed Successfully" });
          } else {
