    ...
    try {
      ...
      const sortingresults = await SortingModel.findAll({
        attributes: [
          ...
          // SUM each issue field and alias the result properly
          [
            sequelize.fn('SUM', sequelize.col('issue_jjh')),
            'issue_jjh'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_jjh1')),
            'issue_jjh1'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_sjh')),
            'issue_sjh'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_jk')),
            'issue_jk'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_jk1')),
            'issue_jk1'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_k')),
            'issue_k'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_k1')),
            'issue_k1'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_lwp1')),
            'issue_lwp1'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_lwp')),
            'issue_lwp'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_s')),
            'issue_s'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_ss')),
            'issue_ss'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_yk')),
            'issue_yk'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_sp2')),
            'issue_sp2'
          ],
          [
            sequelize.fn('SUM', sequelize.col('issue_kp')),
            'issue_kp'
          ]
        ],
        group: ['origin'],
